...
if __name__ == "__main__":
    ...
    # znorm
    # TODO: perform the z-normalization
    ...
    # initialize model
    # TODO: go inside the CNN and complete the missing parts
    inshape = (1,size,size)
    model = CNN(inshape, nclasses)
    ...
    #  Q.2  Again, what is the task? which loss should we use?
    criterion = None
    ...
    # Q. How can we improve the results? Try editing the network
    # Modify the architecture, keeping the epochs at 300 to increase the performance.
    # Try changing activation functions, or filter sizes, or kernel dimension, etc..
